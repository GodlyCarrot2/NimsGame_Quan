...
public class Game {
    ...
    public Game(Player p1, Player p2){
        pieces = (int)(Math.random()*41) +10;//To Do: Grab a random value between 10 and 50 DONE?
        this.p1 = p1;
        this.p2 = p2;
    }
    ...
    public int takePiece(){
       ...
       //TO DO: Grab the user amount of pieces and repeat if it not allowed. DONE?
        while (!isLegal(take)){
            System.out.println("How many pieces would you like to take, " + currentPlayer.getName() + "?");
